...
void Central_ScanEventHandler(uint32 event, BLEAppUtil_msgHdr_t *pMsgData)
{
    ...
    switch (event)
    {
        ...
        {
            centralScanIndex = 0;
            Display_printf(handle, 0, 0, "Scan started...");
        ...
        case BLEAPPUTIL_SCAN_DISABLED:
        {
            ...
            Display_printf(handle, 0, 0, "Scan disabled - Reason: %d Num results:  %d", scanMsg->pBuf->pScanDis.reason, scanMsg->pBuf->pScanDis.numReport);
            break;
        }
