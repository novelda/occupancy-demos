...
void App_StackInitDoneHandler(gapDeviceInitDoneEvent_t *deviceInitDoneData)
{
    ...
    if (handle == NULL)
    {
        ...
        Display_printf(handle, 0, 0, "Failed to open display driver");
        while (1) {}
    }

    Display_printf(handle, 0, 0, "********** Novelda Occupancy example **********");
